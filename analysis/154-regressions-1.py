...
def main() -> int:
    ...
    # change the bins to be from 1880 every 10 years to 1930+
    bins = [1880, 1890, 1900, 1910, 1920, 1930, np.inf]; labels = ['1880-1889', '1890-1899', '1900-1909', '1910-1919', '1920-1929', '1930+']
