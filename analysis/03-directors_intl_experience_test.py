...
def main():
    ...
    directors_df.to_csv(os.path.join(OUTPUT_DIR, 'directors_international_experience.csv'), index=False)
    
    # Save the full data (including position details) to JSON
    with open(os.path.join(OUTPUT_DIR, 'directors_international_experience_full.json'), 'w', encoding='utf-8') as f:
    ...
    decade_stats.to_csv(os.path.join(OUTPUT_DIR, 'directors_international_experience_by_decade.csv'), index=False)
